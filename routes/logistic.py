...
#     try:
#         accuracy, data_to_return, _ = train_and_save_model(df, 'logistic_regression')
#     except Exception as e:
...
async def train_logistic(file: UploadFile = File(...)):
    ...
    if not fraud_predictions.empty:
        ...
        email_content = {
            ...
            "to": os.getenv("ADMIN_EMAIL", "manisaisaduvala21@gmail.com")  # Use the environment variable for the recipient  # Replace with the actual recipient email
        }
